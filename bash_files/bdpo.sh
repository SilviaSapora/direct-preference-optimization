...
python -u train.py exp_name=anthropic_bdpo_pythia69 model=pythia28 datasets=[hh] loss=b-dpo loss.beta=0.1 gradient_accumulation_steps=2 batch_size=64 eval_batch_size=32 trainer=FSDPTrainer sample_during_eval=false model.fsdp_policy_mp=bfloat16 model.archive=/vols/bitbucket/caalfano/.cache/caalfano/anthropic_dpo_pythia28_2024-03-14_11-45-43_711605/step-159744/policy.pt
